              ...
              <CardContent className="space-y-6">
                <div className="grid gap-4">
                  {homepage.recent.map((item) => {
                    const itemImage = item.transparentImageUrl || item.imageUrl

                    return (
                      <Link
                        key={item.id}
                        href={`/perfumes/${item.slug}`}
                        className="luxury-hover-soft flex items-center gap-4 rounded-[1.2rem] border border-border/60 px-4 py-4 transition-colors dark:bg-background/40 dark:hover:bg-background/60"
                      >
                        <div className="luxury-canvas relative flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-[1rem] border border-border/50 bg-background/70 dark:bg-background/50">
                          {itemImage ? (
                            <Image
                              src={itemImage}
                              alt={item.name}
                        ...
                        <div className="shrink-0 text-sm text-muted-foreground">{item.price}</div>
                      </Link>
                    )
                  })}
                </div>
            ...
            <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
              <div className="space-y-4">
                ...
                <p className="max-w-sm text-sm leading-7 text-muted-foreground">
                  A modern perfume house for signature scents, thoughtful gifting, and
                  wardrobe-building rituals designed around mood, memory, and skin.
                </p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-3 text-sm text-muted-foreground">
                  ...
                  <a href="#gifting" className="transition-colors hover:text-foreground">
                    Discovery sets
                  </a>
                </div>
              </div>
